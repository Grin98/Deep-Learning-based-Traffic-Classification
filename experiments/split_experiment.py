...
# python experiments/split_experiment.py --data-dir data_cv_net_reg1 --out-dir del --data-format 1 --bs-train 128 --bs-test 256 --epochs 40 --print-every 5 --lr 0.001 --reg 0.0001 --save-checkpoint 1 --load-checkpoint 0 --checkpoint-every 50 --hidden-dims 64 --filters-per-layer 10 20 --layers-per-block 1 --parallel 1 --verbose 1
